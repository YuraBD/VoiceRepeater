...
#endif //defined (CY_USING_HAL)
const cy_stc_gpio_pin_config_t DYN_OUT_config = 
{
    .outVal = 0,
    .driveMode = CY_GPIO_DM_ANALOG,
    .hsiom = DYN_OUT_HSIOM,
...
#if defined (CY_USING_HAL)
    const cyhal_resource_inst_t DYN_OUT_obj = 
    {
        .type = CYHAL_RSC_GPIO,
        .block_num = DYN_OUT_PORT_NUM,
        .channel_num = DYN_OUT_PIN,
    };
#endif //defined (CY_USING_HAL)
...
#endif //defined (CY_USING_HAL)
const cy_stc_gpio_pin_config_t MIC_IN_config = 
{
    .outVal = 0,
    .driveMode = CY_GPIO_DM_ANALOG,
    .hsiom = MIC_IN_HSIOM,
...
#if defined (CY_USING_HAL)
    const cyhal_resource_inst_t MIC_IN_obj = 
    {
        .type = CYHAL_RSC_GPIO,
        .block_num = MIC_IN_PORT_NUM,
        .channel_num = MIC_IN_PIN,
    };
#endif //defined (CY_USING_HAL)
...
#if defined (CY_USING_HAL)
    cyhal_hwmgr_reserve(&DYN_OUT_obj);
#endif //defined (CY_USING_HAL)
...
#if defined (CY_USING_HAL)
    cyhal_hwmgr_reserve(&MIC_IN_obj);
#endif //defined (CY_USING_HAL)
