...
#define ioss_0_port_0_pin_5_INIT_DRIVESTATE 0
...
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define ioss_0_port_0_pin_5_HAL_DIR CYHAL_GPIO_DIR_OUTPUT 
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define ioss_0_port_0_pin_5_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_STRONG
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#endif //defined (CY_USING_HAL)
#define DYN_OUT_ENABLED 1U
#define DYN_OUT_PORT GPIO_PRT5
#define DYN_OUT_PORT_NUM 5U
#define DYN_OUT_PIN 7U
#define DYN_OUT_NUM 7U
#define DYN_OUT_DRIVEMODE CY_GPIO_DM_ANALOG
#define DYN_OUT_INIT_DRIVESTATE 0
#ifndef ioss_0_port_5_pin_7_HSIOM
    #define ioss_0_port_5_pin_7_HSIOM HSIOM_SEL_GPIO
#endif
#define DYN_OUT_HSIOM ioss_0_port_5_pin_7_HSIOM
#define DYN_OUT_IRQ ioss_interrupts_gpio_5_IRQn
#if defined (CY_USING_HAL)
    #define DYN_OUT_HAL_PORT_PIN P5_7
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define DYN_OUT P5_7
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define DYN_OUT_HAL_IRQ CYHAL_GPIO_IRQ_NONE
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define DYN_OUT_HAL_DIR CYHAL_GPIO_DIR_INPUT 
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define DYN_OUT_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_ANALOG
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#endif //defined (CY_USING_HAL)
#define MIC_IN_ENABLED 1U
#define MIC_IN_PORT GPIO_PRT6
#define MIC_IN_PORT_NUM 6U
#define MIC_IN_PIN 5U
#define MIC_IN_NUM 5U
#define MIC_IN_DRIVEMODE CY_GPIO_DM_ANALOG
#define MIC_IN_INIT_DRIVESTATE 0
#ifndef ioss_0_port_6_pin_5_HSIOM
    #define ioss_0_port_6_pin_5_HSIOM HSIOM_SEL_GPIO
#endif
#define MIC_IN_HSIOM ioss_0_port_6_pin_5_HSIOM
#define MIC_IN_IRQ ioss_interrupts_gpio_6_IRQn
#if defined (CY_USING_HAL)
    #define MIC_IN_HAL_PORT_PIN P6_5
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define MIC_IN P6_5
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define MIC_IN_HAL_IRQ CYHAL_GPIO_IRQ_NONE
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define MIC_IN_HAL_DIR CYHAL_GPIO_DIR_INPUT 
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define MIC_IN_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_ANALOG
#endif //defined (CY_USING_HAL)
...
#endif //defined (CY_USING_HAL)
extern const cy_stc_gpio_pin_config_t DYN_OUT_config;
#if defined (CY_USING_HAL)
    extern const cyhal_resource_inst_t DYN_OUT_obj;
#endif //defined (CY_USING_HAL)
extern const cy_stc_gpio_pin_config_t CYBSP_SWO_config;
#if defined (CY_USING_HAL)
    extern const cyhal_resource_inst_t CYBSP_SWO_obj;
#endif //defined (CY_USING_HAL)
extern const cy_stc_gpio_pin_config_t MIC_IN_config;
#if defined (CY_USING_HAL)
    extern const cyhal_resource_inst_t MIC_IN_obj;
#endif //defined (CY_USING_HAL)
