...
#include "cycfg_clocks.h"
    ...
    const cyhal_resource_inst_t VOICE_CLOCK_obj = 
    {
        .type = CYHAL_RSC_CLOCK,
        .block_num = VOICE_CLOCK_HW,
        .channel_num = VOICE_CLOCK_NUM,
    };
...
void init_cycfg_clocks(void)
{
    ...
    Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_16_BIT, 0U, 99U);
    Cy_SysClk_PeriphEnableDivider(CY_SYSCLK_DIV_16_BIT, 0U);
#if defined (CY_USING_HAL)
    cyhal_hwmgr_reserve(&VOICE_CLOCK_obj);
#endif //defined (CY_USING_HAL)
