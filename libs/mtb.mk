...
SEARCH_csdadc=../mtb_shared/csdadc/release-v2.0.0
SEARCH_csdidac=../mtb_shared/csdidac/release-v2.10.0
...
SEARCH_mtb-pdl-cat1=../mtb_shared/mtb-pdl-cat1/release-v2.3.0
SEARCH_psoc6cm0p=../mtb_shared/psoc6cm0p/release-v2.1.3
SEARCH_recipe-make-cat1a=../mtb_shared/recipe-make-cat1a/release-v1.9.0

# Shared libraries added to build 
SEARCH+=$(SEARCH_csdadc)
SEARCH+=$(SEARCH_csdidac)
